        ...
        while attempts < 500:
            ...
            if actual_sub_t == "อัตราส่วนอายุ":
                ...
                if is_challenge:
                    ...
                    <b>ขั้นที่ 1: หาอายุปัจจุบันของ {n1}</b><br>
                    👉 อัตราส่วน {n1}:{n2} คือ {r1_a}:{r1_b} และเรารู้ว่า {n2} อายุ {b_now} ปี<br>
                    👉 นำอายุจริงของ {n2} หารด้วยสัดส่วนของ {n2} จะได้ส่วนละ: {b_now} ÷ {r1_b} = {b_now//r1_b} ปี<br>
                    👉 นำไปคูณสัดส่วนของ {n1}: {r1_a} × {b_now//r1_b} = <b>{a_now} ปี</b><br>
                    <b>ขั้นที่ 2: หาอายุปัจจุบันของ {n3}</b><br>
                    👉 อัตราส่วน {n2}:{n3} คือ {r2_b}:{r2_c} และ {n2} อายุ {b_now} ปี<br>
                    👉 จะได้ส่วนละ: {b_now} ÷ {r2_b} = {b_now//r2_b} ปี<br>
                    👉 นำไปคูณสัดส่วนของ {n3}: {r2_c} × {b_now//r2_b} = <b>{c_now} ปี</b><br>
                    <b>ขั้นที่ 3: หาอายุในอีก {f} ปีข้างหน้า</b><br>
                    👉 ให้นำอายุปัจจุบันของทุกคนมาบวกเพิ่มไปอีกคนละ {f} ปี<br>
                    👉 {n1}: {a_now} + {f} = <b>{af} ปี</b><br>
                    👉 {n2}: {b_now} + {f} = <b>{bf} ปี</b><br>
                    👉 {n3}: {c_now} + {f} = <b>{cf} ปี</b><br>
                    <b>ขั้นที่ 4: ทำเป็นอัตราส่วนอย่างต่ำ</b><br>
                    👉 อัตราส่วนคือ {af} : {bf} : {cf} นำเลข {g_ans} มาหารทุกตัวจะได้ <b>{af//g_ans}:{bf//g_ans}:{cf//g_ans}</b><br>
            ...
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    <b>ขั้นที่ 2: ใช้วิธีสุ่มแจกแจงตัวเลข (Trial and Error)</b><br>
            ...
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    total_digits = 9 + 180 + ((target_pages - 99) * 3) if target_pages > 99 else 9 + ((target_pages - 9) * 2)
                    q = f"<b>{publisher}</b> พิมพ์ตัวเลขหน้าหนังสือ<b>{book_type}</b> เริ่มตั้งแต่หน้า 1 เมื่อพิมพ์เสร็จ พบว่าใช้ตัวเลขโดด (0-9) ไปทั้งหมด <b>{total_digits:,} ตัว</b> จงหาว่าหนังสือเล่มนี้มีทั้งหมดกี่หน้า?"
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดอย่างละเอียด (Step-by-Step):</b><br>
            ...
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดอย่างละเอียด (Step-by-Step):</b><br>
                    <b>ขั้นที่ 1: หาพื้นที่สี่เหลี่ยมจัตุรัสแผ่นใหญ่ทั้งหมด</b><br>
            ...
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    👉 นำมารวมกันเป็นวันเดินทางทั้งหมด: {start_days - s_d} + {mid_days} + {t_d} = <b>{add_days} วัน</b><br>
                    <b>ขั้นที่ 2: นำไปหาร 7 (ตัดสัปดาห์เต็มทิ้ง)</b><br>
            ...
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดอย่างละเอียด (Step-by-Step):</b><br>
                    <b>ขั้นที่ 1: หาจำนวนคนทั้งหมดจากรหัสฝั่งตรงข้าม</b><br>👉 ระยะห่างระหว่างสองคนที่ยืนอยู่ฝั่งตรงข้ามกัน คือ 'ครึ่งวงกลม' เสมอ<br>👉 หาคนครึ่งวงกลม = นำเบอร์มาลบกัน ➔ {pos2} - {pos1} = <b>{n_half} คน</b><br>👉 หาคนเต็มวงกลม = ครึ่งวงกลม × 2 ➔ {n_half} × 2 = <b>{total} คน</b><br>
                    <b>ขั้นที่ 2: หาตำแหน่งที่ยืนของ {n3}</b><br>👉 {n3} ยืนถัดจาก {pos2} ไปอีก {add_pos} ตำแหน่ง: {pos2} + {add_pos} = <b>{pos2+add_pos}</b><br>👉 (ข้อควรระวัง: ถ้ายอดการนับเกินจำนวนคนรวม ให้หักออกเป็นรอบๆ ด้วย {total})<br>👉 หมายเลขสุดท้ายของ {n3} จะไปตกที่ตำแหน่ง <b>{pos3}</b><br>
            ...
            # ---------------------------------------------------------
            # 20. เศษส่วนของที่เหลือ (ปรับเศษส่วนแนวตั้ง 100%)
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดย้อนกลับแบบ Step-by-Step:</b><br>
                    เราจะคิดย้อนจากเหตุการณ์สุดท้ายกลับไปหาจุดเริ่มต้น<br>
                    <b>ขั้นที่ 1: ฉากฝากธนาคาร (ย้อนกลับหาเงินก่อนฝาก)</b><br>👉 ฝากไป {f1_C} ➔ แสดงว่า <b>เหลือ {f_rem_C}</b> ซึ่งเงินที่เหลือนี้เทียบเท่ากับเงินกลับบ้าน {D} บาท<br>👉 เทียบบัญญัติไตรยางศ์: {C-1} ส่วน = {D} บาท ดังนั้น 1 ส่วน = {D//(C-1)} บาท<br>👉 เงินก่อนฝาก (เต็ม {C} ส่วน) = ({D} ÷ {C-1}) × {C} = <b>{before_bank} บาท</b><br>
                    <b>ขั้นที่ 2: ฉากซื้อของเล่น (ย้อนกลับหาเงินก่อนซื้อของเล่น)</b><br>👉 จ่ายเงินสดไป {B} บาท ทำให้เหลือ {before_bank} บาท<br>👉 เงินก่อนซื้อของเล่น = นำกลับมาบวกคืน: {before_bank} + {B} = <b>{target} บาท</b><br>
                    <b>ขั้นที่ 3: ฉากซื้อขนม (ย้อนกลับหาเงินก้อนแรกสุด)</b><br>👉 ซื้อขนมไป {f1_A} ➔ แสดงว่า <b>เหลือ {f_rem_A}</b> ซึ่งเทียบเท่ากับยอดเงิน {target} บาท<br>👉 เทียบบัญญัติไตรยางศ์: {A-1} ส่วน = {target} บาท ดังนั้น 1 ส่วน = {target//(A-1)} บาท<br>👉 เงินตั้งต้นแรกสุด (เต็ม {A} ส่วน) = ({target} ÷ {A-1}) × {A} = <b>{Original:,} บาท</b><br>
                    ...
                    <b>ขั้นที่ 1: คำนวณก้อนแรก (ซื้อขนม)</b><br>👉 ซื้อไป {f1_html_s} ของเงินทั้งหมด ({tot:,} บาท)<br>👉 ซื้อขนม = ({f1_n} × {tot:,}) ÷ {f1_d} = <b>{spent1:,} บาท</b><br>👉 <u>เงินคงเหลือรอบแรก</u> = {tot:,} - {spent1:,} = <b>{rem1:,} บาท</b><br>
                    <b>ขั้นที่ 2: คำนวณก้อนที่สอง (ซื้อ{item})</b><br>👉 ซื้อไป {f2_html_s} <b>ของเงินที่เหลือ</b> (ซึ่งก็คือต้องคิดจากยอด {rem1:,} บาท)<br>👉 ซื้อ{item} = ({f2_n} × {rem1:,}) ÷ {f2_d} = <b>{spent2:,} บาท</b><br>
                    <b>ขั้นที่ 3: หาเงินคงเหลือสุทธิ</b><br>👉 นำเงินคงเหลือรอบแรกลบด้วยเงินที่จ่ายไปในรอบที่สอง: {rem1:,} - {spent2:,} = <b>{ans:,} บาท</b><br>
            ...
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    <b>ขั้นที่ 1: ใช้กฎของเลขสลับหลัก</b><br>👉 ผลต่างของจำนวน 2 หลักที่สลับหลักกัน (BA - AB) จะมีค่าเท่ากับ 'ผลต่างของเลขโดด × 9' เสมอ!<br>👉 ดังนั้นเราหาระยะห่างระหว่างเลข B กับ A ได้โดย: B - A = {k} ÷ 9 = <b>{diff}</b><br>
                    <b>ขั้นที่ 2: แก้สมการหาค่า A และ B</b><br>👉 เรารู้ว่า ผลบวกของเลขโดด = {sum_val} และ ผลต่าง = {diff}<br>👉 หาตัวเลขที่มากกว่า (B) = (ผลบวก + ผลต่าง) ÷ 2 ➔ ({sum_val} + {diff}) ÷ 2 = <b>{b}</b><br>👉 หาตัวเลขที่น้อยกว่า (A) = ผลบวก - ตัวที่มากกว่า ➔ {sum_val} - {b} = <b>{a}</b><br>
                    ...
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดอย่างละเอียด (Step-by-Step):</b><br>
                    <b>ขั้นที่ 1: จัดรูปสมการ</b><br>👉 ย้ายข้างสมการ จะได้ BA - AB = {k}<br>
                    ...
                    <b>ขั้นที่ 3: หาค่าเลขโดด</b><br>👉 ผลบวก={sum_val}, ผลต่าง={diff} <br>👉 หา B: ({sum_val} + {diff}) ÷ 2 = <b>{b}</b><br>👉 หา A: {sum_val} - {b} = <b>{a}</b><br>
            ...
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดอย่างละเอียด (Step-by-Step สูตรความหนาเชือก):</b><br>
                    <b>ขั้นที่ 1: หาความหนาของเชือกหลังจากพับ</b><br>👉 การพับครึ่ง 1 ครั้ง ความหนาของเชือกจะเพิ่มขึ้นเป็น 2 เท่า (คิดเป็น 2 ยกกำลัง)<br>👉 พับ {f} ครั้ง = นำ 2 มาคูณกัน {f} ครั้ง ➔ <b>{2**f} ชั้น</b><br>
                    <b>ขั้นที่ 2: หาจำนวนเส้นที่ได้เพิ่มจากการตัด</b><br>👉 การใช้กรรไกรตัด 1 รอยตรงกลางเชือก จะทำให้เกิดเชือกเส้นใหม่เพิ่มขึ้นเท่ากับ "จำนวนชั้น"<br>👉 ดังนั้น ตัด {c} รอย = ได้เชือกเพิ่มมา {2**f} × {c} = <b>{(2**f)*c} เส้น</b><br>
                    <b>ขั้นที่ 3: รวมเชือกเส้นตั้งต้น</b><br>👉 นำจำนวนเส้นที่ถูกตัดเพิ่ม ไปบวกกับเชือกเส้นเดิมก่อนพับอีก 1 เส้น: {(2**f)*c} + 1 = <b>{ans} เส้น</b><br>
                    ...
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดอย่างละเอียด (Step-by-Step):</b><br>
                    <b>ขั้นที่ 1: หาความหนา</b><br>👉 พับ {f} ครั้ง เกิดความหนา = 2 ยกกำลัง {f} = <b>{2**f} ชั้น</b><br>
                    <b>ขั้นที่ 2: หาเส้นที่ถูกตัด</b><br>👉 ตัด {c} รอย ได้เส้นเพิ่ม = {2**f} × {c} = <b>{(2**f)*c} เส้น</b><br>
                    <b>ขั้นที่ 3: รวมเส้นตั้งต้น</b><br>👉 รวมกับเส้นตั้งต้นที่มีอยู่แล้ว 1 เส้น: {(2**f)*c} + 1 = <b>{ans} เส้น</b><br>
                    <b>ตอบ: {ans} เส้น</b></span>"""
            ...
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดอย่างละเอียด (Step-by-Step การบวกอายุเป็นกลุ่ม):</b><br>
                    โจทย์ข้อนี้เป็นตัวหลอก! ให้ข้อมูลอดีตมาเพื่อสร้างความสับสน เราสามารถข้ามไปคิดเรื่องอนาคตได้เลย<br>
                    <b>ขั้นที่ 1: วิเคราะห์การเติบโตในอนาคต</b><br>👉 อีก {future_years} ปีข้างหน้า <b>ทุกคน (ทั้ง 3 คน)</b> จะมีอายุเพิ่มขึ้นพร้อมๆ กันคนละ {future_years} ปี<br>
                    <b>ขั้นที่ 2: หาอายุรวมที่เพิ่มขึ้นของกลุ่ม</b><br>👉 นำ {future_years} ปี × 3 คน = <b>อายุเพิ่มขึ้นรวม {3*future_years} ปี</b><br>
                    <b>ขั้นที่ 3: หาผลรวมในอนาคต</b><br>👉 นำอายุรวมปัจจุบัน ไปบวกกับ อายุรวมที่เพิ่มขึ้น: {current_sum} + {3*future_years} = <b>{future_sum} ปี</b><br>
                    ...
                    sol = f"""<span style='color:#2c3e50;'><b>วิธีคิดอย่างละเอียด (Step-by-Step):</b><br>
                    <b>ขั้นที่ 1: หาอายุรวมที่ลดลง</b><br>👉 ย้อนเวลาไป {past_years} ปี <b>ทุกคน (ทั้ง 2 คน)</b> จะมีอายุน้อยลงคนละ {past_years} ปี<br>👉 หักอายุออกรวม = 2 × {past_years} = <b>{2*past_years} ปี</b><br>
                    <b>ขั้นที่ 2: หายอดรวมในอดีต</b><br>👉 นำอายุรวมปัจจุบันตั้ง ลบด้วยอายุที่ลดลง: {current_sum} - {2*past_years} = <b>{past_sum} ปี</b><br>
            ...
            # ---------------------------------------------------------
            # 25. งานและเวลา (Work) - ปรับเศษส่วนแนวตั้ง 100%
            # ---------------------------------------------------------
                ...
                if is_challenge:
                    ...
                    <b>ขั้นที่ 1: หาผลงานใน 1 วันของแต่ละคน</b><br>
                    👉 {n1} ทำได้ {f1_s}, {n2} ทำได้ {f2_s}, {n3} ทำได้ {f3_s} ของงานทั้งหมด<br>
                    <b>ขั้นที่ 2: นำผลงานใน 1 วันมาบวกกัน (ทำตัวส่วนให้เท่ากันด้วย ค.ร.น.)</b><br>
                    ...
                    <b>ขั้นที่ 3: พลิกกลับเศษเป็นส่วนเพื่อหาจำนวนวัน</b><br>
...
if st.sidebar.button(f"{'🚀 สั่งสร้างข้อสอบระดับ Ultimate Challenge!' if is_challenge else '🚀 สั่งสร้างข้อสอบแข่งขันเดี๋ยวนี้'}", type="primary", use_container_width=True):
    with st.spinner("กำลังออกแบบข้อสอบและจัดทำเฉลยแบบ Step-by-Step พร้อมเศษส่วนแนวตั้ง..."):
...
if 'ebook_html' in st.session_state:
    st.success(f"✅ โค้ดสมบูรณ์เต็มรูปแบบ! จัดเต็มเฉลยละเอียดยิบแบบ Step-by-step และล้างเศษส่วนแนวนอนทิ้ง 100% แล้วครับ")
    c1, c2 = st.columns(2)
    with c1:
